...
func (db *MinDB) ZRank(key, member []byte) int64 {
...
func (db *MinDB) ZRevRank(key, member []byte) int64 {
...
func (db *MinDB) ZIncrBy(key []byte, increment float64, member []byte) (float64, error) {
...
func (db *MinDB) ZRange(key []byte, start, stop int) []interface{} {
...
func (db *MinDB) ZRevRange(key []byte, start, stop int) []interface{} {
...
func (db *MinDB) ZRem(key, member []byte) (ok bool, err error) {
...
func (db *MinDB) ZScoreRange(key []byte, min, max float64) []interface{} {
...
func (db *MinDB) ZRevScoreRange(key []byte, max, min float64) []interface{} {
	if err := db.checkKeyValue(key, nil); err != nil {
		return nil
	}
